...
# route_test_val_veh_1 = cij[0,1] + cij[1,11] + cij[11,7] + cij[7,4] + cij[4,12] + cij[12,6] + cij[6,9]
# route_test_val_veh_2 = cij[0,3] + cij[3,10] + cij[10,5] + cij[5,2] + cij[2,10] + cij[10,8] + cij[8,9]

# route_test_val_veh_1_paper = cij[0,11] + cij[11,7] + cij[7,4] + cij[4,6] + cij[6,11] + cij[11,9]
# route_test_val_veh_2_paper = cij[0,1] + cij[1,3] + cij[3,2] + cij[2,5] + cij[5,10]  + cij[10,8] + cij[8,9] 

# print("my value ", route_test_val_veh_1 + route_test_val_veh_2)
# print("paper's value ", route_test_val_veh_1_paper + route_test_val_veh_2_paper)
